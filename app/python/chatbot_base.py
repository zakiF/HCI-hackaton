"""
ChatSeq - BASE VERSION (Backup)
Simple chatbot for visualizing gene expression - NO experimental features

This is the SAFE backup version. If integration fails during the hackathon,
you can run this version for the demo.
...
st.set_page_config(
    page_title="ChatSeq - Base Version",
    page_icon="🧬",
    layout="wide",
...
with st.sidebar:
    st.title("⚙️ ChatSeq BASE")
    st.caption("Backup Version - Core Functionality Only")
...
st.title("🧬 ChatSeq - Base Version")
st.markdown("*Core Gene Expression Visualization (No Experimental Features)*")
